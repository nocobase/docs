...
- [x] \u5B8C\u4E86\u3057\u305F\u30BF\u30B9\u30AF
- [ ] \u672A\u5B8C\u4E86\u306E\u30BF\u30B9\u30AF
`}],t=function(){var p=(0,n.useState)(null),a=d()(p,2),b=a[0],g=a[1],R=(0,r.WF)(),N=R.themeConfig,v=N.lang.slice(0,2),E=function(D){return o.map(function(A){return A[D]||A.en}).join(`
`)};return(0,n.useEffect)(function(){var y=E(v),D=new(h())("vditor",{value:y,after:function(){g(D)}});return function(){D.destroy(),g(null)}},[v]),(0,n.useEffect)(function(){if(b){var y=E(v);b.setValue(y)}},[v]),(0,i.jsx)("div",{id:"vditor",className:"vditor"})};x.Z=t},66893:function(C,x,e){"use strict";var l=e(42122),d=e.n(l),n=e(67294),u=e(33783),h=e(1191),m=e(85893),r=[{category:"Expression functions",functions:[{title:"compile",call:"compile('2 + 3')",result:"{}",definition:{en:"Parse and compile an expression (no direct calculation).",cn:"\u89E3\u6790\u5E76\u7F16\u8BD1\u8868\u8FBE\u5F0F\uFF08\u8D1F\u8D23\u89E3\u6790\uFF0C\u4E0D\u76F4\u63A5\u8FD4\u56DE\u7ED3\u679C\uFF09\u3002",ja:"\u5F0F\u3092\u89E3\u6790\u3057\u3001\u30B3\u30F3\u30D1\u30A4\u30EB\u3057\u307E\u3059\uFF08\u8A55\u4FA1\u306F\u3057\u307E\u305B\u3093\uFF09\u3002"},parameterDefinitions:{en:"expr (string)",cn:"\u8868\u8FBE\u5F0F\uFF08\u5B57\u7B26\u4E32\uFF09",ja:"\u5F0F\uFF08\u6587\u5B57\u5217\uFF09"}},{title:"evaluate",call:"evaluate('2 + 3')",result:"5",definition:{en:"Evaluate an expression (and return the result).",cn:"\u8BA1\u7B97\u8868\u8FBE\u5F0F\u5E76\u8FD4\u56DE\u7ED3\u679C\u3002",ja:"\u5F0F\u3092\u8A55\u4FA1\u3057\u3066\u7D50\u679C\u3092\u8FD4\u3057\u307E\u3059\u3002"},parameterDefinitions:{en:"expr (string), scope (object, optional)",cn:"\u8868\u8FBE\u5F0F\uFF08\u5B57\u7B26\u4E32\uFF09\uFF0C\u4F5C\u7528\u57DF\uFF08\u53EF\u9009\uFF09",ja:"\u5F0F\uFF08\u6587\u5B57\u5217\uFF09\u3001\u30B9\u30B3\u30FC\u30D7\uFF08\u30AA\u30D7\u30B7\u30E7\u30F3\uFF09"}},{title:"help",call:"help('evaluate')",result:`{
  "name": "evaluate",
  "category": "Expression",
  "syntax": [
    "evaluate(expression)",
