      ...
      <div className="dumi-default-container markdown" data-type="info">
        ...
        <section>
          {zhCN ? (
            ...
            <p>This feature is provided by the {commercial ? 'commercial ' : ''}plugin <Link to={`/handbook/${name}`}>plugin-{name}</Link>. <br/> Please refer to the <a target="_blank" href="https://www.nocobase.com/commercial.html">commercial license</a> for details.</p>
          )}
        </section>
      </div>
    </div>
