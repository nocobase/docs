...
const CommercialInstallation = (props) => {
  ...
  const isJaJP = lang === 'ja-JP';

  return (
    <div>
      <div className="markdown">
        <h2>
          {isZhCN ? '安装' : isJaJP ? 'インストール' : 'Installation'}
        </h2>
      </div>
      <div className="dumi-default-container markdown" data-type="info">
        ...
        <section>
          {isZhCN ? (
            ...
            <p>このプラグインは商用プラグインであり、プラグインマネージャーを介してアップロードし、アクティブ化する必要があります。</p>
          ) : (
            <p>This is a commercial plugin, which needs to be uploaded and enabled in the plugin manager.</p>
          )}
          <p>
