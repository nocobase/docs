...
![创建人工节点](./6a08d124-7bef-4064-9f9a-f37db40c3927.png)
...
![人工节点_配置_负责人_选择变量](./9d241c64-243c-4da3-89b0-3c4a5538ad5d.png)
...
![人工节点_节点配置_界面配置](./45ff0236-c4bb-4379-af78-a40c782cae6c.png)
...
![人工节点_节点配置_界面配置_数据区块_触发器](./2aca45ec-7e4f-448f-aeec-7e6e80f28a3b.png)

节点数据区块类似，可以选择上游节点中的数据结果作为详情展示。例如上游一个计算节点的结果，作为负责人待办的上下文参考信息：

![人工节点_节点配置_界面配置_数据区块_节点数据](./f861a680-995c-47d5-ad9e-403902eec974.png)
...
![人工节点_节点配置_界面配置_表单类型](./2e4c8b58-ea55-48f6-9c4c-1ebbc07cc940.png)
...
![人工节点_节点配置_界面配置_表单按钮](./8d3f4852-3ad7-4a10-9e41-3f78e0835d8a.png)

三个按钮代表流程处理中三种节点状态，提交后该节点的状态修改为“完成”、“拒绝”或继续处于“等待”的状态，一个表单至少要配置前两者之一，以决定整个流程的后续处理流向。

在“继续流程”按钮上可以配置对表单字段的赋值：

![人工节点_节点配置_界面配置_表单按钮_设置表单值](./e62e86fe-39c3-4bbc-b7b6-6bb5d69c3212.png)

![人工节点_节点配置_界面配置_表单按钮_设置表单值弹窗](./ba5bc9b6-d8ac-4588-9381-399e247b7efb.png)
...
![人工节点_添加待办区块](./d88cc678-a2ff-4a48-a353-484177886b7a.png)

待办列表区块示例：

![人工节点_待办列表](./b4f15922-0e63-4668-aa94-dda84fba4a6b.png)

之后相关人员可以点击对应的待办任务，进入待办弹窗，进行人工处理：

![人工节点_待办详情](./7eebb3f9-042a-46a1-8924-b30f157a6044.png)
