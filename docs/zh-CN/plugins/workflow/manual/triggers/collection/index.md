...
![数据表事件_触发时机选择](https://github.com/nocobase/nocobase/assets/525658/74ff83ec-466b-4f8d-a87c-ee57095be99e)

可以根据业务的不同需要选择触发的时机。当选择变动情况中包含更新数据表的情况时，还可以对发生变动的字段进行限定，只有选中字段发生变动时，才满足触发条件，不选择则代表所有字段发生变动都可以触发。

![数据表事件_发生变动的字段选择](https://github.com/nocobase/nocobase/assets/525658/111ea483-7e8f-4665-aaba-b2ade7a91772)

更细节地，可以对触发的数据行的各个字段配置条件规则，当其中的字段满足相应条件，才进行触发。

![数据表事件_配置数据满足的条件](https://github.com/nocobase/nocobase/assets/525658/c53e9d34-b898-4983-9c9b-41998798c0dc)
...
![数据表事件_示例_新增订单触发](https://github.com/nocobase/nocobase/assets/525658/65b30fb6-1f92-4093-83fa-7b7fbbba2aeb)
...
![数据表事件_示例_新增订单流程编排](https://github.com/nocobase/nocobase/assets/525658/feaa247e-8f1f-47f9-b5d1-940f44214a56)

节点的配置会在具体类型的介绍文档中详细说明。

启用该工作流，并通过界面新增订单来测试。对“iPhone 14 Pro”下单后，对应商品的库存会扣减为 9，而如果对“iPhone 13 Pro”下单，由于库存不足，订单将被删除。

![数据表事件_示例_新增订单执行结果](https://github.com/nocobase/nocobase/assets/525658/b7ce1e40-f0a3-4afa-82d9-05b00c9a6b63)
