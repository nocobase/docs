...
- [插件开发 / Schema 初始化器 / 向已有的初始化器里添加项](http://localhost:8000/development/client/ui-schema/initializer)
...
- [插件开发 / SchemaSettings 设置器 / 如何实现 Schema 的设置](http://localhost:8000/development/client/ui-schema/settings)
