...
![条件判断_模式选择](./dac253b8-4b45-414c-abd5-e3f6908a60cd.png)

“‘是’则继续”的模式下，当条件判断的结果为“是”时，流程将继续执行后续节点，否则流程将终止，并以失败的状态提前退出。

![“是”则继续模式](./d4046c6c-d44c-4d31-8b94-6231459a1415.png)
...
![“是”和“否”分别继续模式](./2b791162-bfcc-4079-be41-4dfdf18cf782.png)
