...
![创建聚合查询节点](./0e7c1609-a30b-4071-8f71-ee863bade0d3.png)

### 节点配置

![聚合查询节点_节点配置](./26bd7262-7f98-4651-a8c3-b2a6eb1c7c69.png)
...
![聚合查询节点_示例_节点配置](./6c3e8dde-dbfe-4042-91c7-0c2993bbba82.png)
