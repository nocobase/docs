            ...
            children: [
              {
                title: 'Table column',
                'title.zh-CN': '表格字段',
                link: '/handbook/ui/fields/field-settings/generic/table-column',
              },
              {
                title: 'Form',
                'title.zh-CN': '表单字段',
                link: '/handbook/ui/fields/field-settings/generic/form-item',
              },
              {
                title: 'Detail',
                'title.zh-CN': '详情字段',
                link: '/handbook/ui/fields/field-settings/generic/detail-form-item',
              },
              {
                title: 'Bulk edit form',
                'title.zh-CN': '批量编辑表单',
                link: '/handbook/ui/fields/field-settings/generic/bulk-edit-form-item',
              },
              {
                title: 'Filter form',
                'title.zh-CN': '筛选表单',
                link: '/handbook/ui/fields/field-settings/generic/filter-form-item',
              },
              {
                title: 'Collapse',
                'title.zh-CN': '折叠面板',
                link: '/handbook/ui/fields/field-settings/generic/filter-collapse-item',
              },
            ],
          },
          {
            ...
            children: [
              {
                title: 'Date picker',
                'title.zh-CN': '时间日期',
                link: '/handbook/ui/fields/field-settings/specific/date-picker',
              },
              {
                title: 'Cascade select',
                'title.zh-CN': '级联选择',
                link: '/handbook/ui/fields/field-settings/specific/cascade-select',
              },
              {
                title: 'Nester',
                'title.zh-CN': '子表单',
                link: '/handbook/ui/fields/field-settings/specific/nester',
              },
              {
                title: 'Popover nester',
                'title.zh-CN': '子表单（弹窗）',
                link: '/handbook/ui/fields/field-settings/specific/popover-nester',
              },
              {
                title: 'Select',
                'title.zh-CN': '选择器',
                link: '/handbook/ui/fields/field-settings/specific/select',
              },
              {
                title: 'Record picker',
                'title.zh-CN': '数据选择器',
                link: '/handbook/ui/fields/field-settings/specific/picker',
              },
              {
                title: 'Sub table',
                'title.zh-CN': '子表格',
                link: '/handbook/ui/fields/field-settings/specific/sub-table',
              },
              {
                title: 'Tag',
                'title.zh-CN': '标签',
                link: '/handbook/ui/fields/field-settings/specific/tag',
              },
              {
                title: 'File manager',
                'title.zh-CN': '文件管理器',
                link: '/handbook/ui/fields/field-settings/specific/file-manager',
              },
            ],
          },
        ],
