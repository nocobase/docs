            ...
            children: [
              {
                ...
                'title.zh-CN': '编辑字段标题',
                link: '/handbook/ui/fields/field-settings/edit-title.md',
              },
              {
                title: 'Display title',
                'title.zh-CN': '显示标题',
                link: '/handbook/ui/fields/field-settings/display-title.md',
              },
              {
                title: 'Edit description',
                'title.zh-CN': '编辑描述',
                link: '/handbook/ui/fields/field-settings/edit-description.md',
              },
              {
                title: 'Required',
                'title.zh-CN': '必填',
                link: '/handbook/ui/fields/field-settings/required.md',
              },
              {
                title: 'Set validation rules',
                'title.zh-CN': '验证规则',
                link: '/handbook/ui/fields/field-settings/validation-rules.md',
              },
              {
                title: 'Set default value',
                'title.zh-CN': '默认值',
                link: '/handbook/ui/fields/field-settings/defaultValue.md',
              },
              {
                title: 'Pattern',
                'title.zh-CN': '显示模式',
                link: '/handbook/ui/fields/field-settings/pattern.md',
              },
            ],
          },
        ],
